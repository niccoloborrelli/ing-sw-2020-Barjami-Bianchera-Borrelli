...
public class SwapWorkersRestriction extends  PowerRestrictionAB {
     ...
     */
    public SwapWorkersRestriction(RestrictionAB restrictionAB){
        this.restrictionAB=restrictionAB;
    }

    /**
     * this method sets the spaces in the islandBoard in which player's workers can move
     * @param player is the player who's workers possible movement spaces are to be set
    ...
    /**
     * this method sets the spaces in the islandBoard in which the worker can move thanks to swap workers power
